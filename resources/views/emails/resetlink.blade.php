...
<div class="container d-flex justify-content-center align-items-center flex-column pt-2 mt-4">
   <h3 class="text-primary mb-3">Testlink ISP Partner Program Change Password</h3>
         ...
         <form method="POST" action="#">
            ...
            <div class="form-group mb-3">
               ...
               <div class="border border-dark rounded d-flex flex-row align-items-center">
                  <input type="password" placeholder="Enter Password" id="password" class="form-control border-0 shadow-none" name="password" required>
                  <span style="cursor: pointer;" class=" me-2"><i class="password-toggle-icon1 fas fa-eye" onclick="togglePassword('password')"></i></span>
               </div>
            ...
            <div class="form-group mb-3">
               ...
               <div class="border border-dark rounded d-flex flex-row align-items-center">
                  <input type="password" placeholder="Confirm Password" id="confirm_password" class="form-control border-0 shadow-none" name="password_confirmation" required>
                  <span style="cursor: pointer;" class=" me-2"><i class="password-toggle-icon fas fa-eye" onclick="togglePassword('confirm_password')"></i></span>
               </div>
               <span class="text-danger"></span>
            </div>
